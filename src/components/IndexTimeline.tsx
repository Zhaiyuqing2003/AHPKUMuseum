  ...
  return (
    ...
    <TimelineItem>
        ...
        <TimelineItem>
            ...
            <Grid container spacing={2}>
              <Grid item>
                  <Avatar src = {headmaster7} sx={{ width: 80, height: 80 }}></Avatar>
              </Grid>
                <Grid item xs={12} sm container>
                  <Grid item xs container direction="column" spacing={2}>
                    <Grid item xs>
        ...
        {/* 一条线必须长这样 */}
          ...
          <TimelineItem>
            ...
            <Grid container spacing={2} justifyContent="flex-end">
                ...
                <Avatar src = {headmaster8} sx={{ width: 80, height: 80 }}></Avatar>
              </Grid>
            </TimelineOppositeContent>
            <TimelineSeparator>
              <TimelineConnector />
        ...
        <TimelineItem>
            ...
            <Grid container spacing={2}>
              <Grid item>
                  <Avatar src = {headmaster9} sx={{ width: 80, height: 80 }}></Avatar>
              </Grid>
                <Grid item xs={12} sm container>
                  <Grid item xs container direction="column" spacing={2}>
                    <Grid item xs>
        ...
        {/* 一条线必须长这样 */}
          ...
          <TimelineItem>
            ...
            <Grid container spacing={2} justifyContent="flex-end">
                ...
                <Avatar src = {headmaster10} sx={{ width: 80, height: 80 }}></Avatar>
              </Grid>
            </TimelineOppositeContent>
            <TimelineSeparator>
              <TimelineConnector />
